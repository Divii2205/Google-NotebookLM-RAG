...
export function UploadDropzone({ onFileSelected, busy }: UploadDropzoneProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <p className="text-base font-semibold text-slate-900">Drop a PDF or TXT file here</p>
